...
<body class="d-flex">
  <div class="border width bg-light pt-3" style="position: fixed;top: 50%;left: 50%;transform: translate(-50%, -50%);">
    ...
    <div class="h-50 text-center mx-auto mt-5 justify-content-center" style="width: 75%;">
      <form action="<?php echo site_url('auth_petugas/login') ?>" method="post">
        ...
        <div class="col-lg-12 mb-5 font">
          <div class="col-lg-8 mx-auto">
            <button class="w-100" id="submit-btn" type="submit" name="submit" value="SAVE">LOGIN</button>
          </div>
          <div class="col-lg-12 mt-3">
            <p id="signup"><a href="<?= base_url('petugas/register') ?>" id="signup">Have Account /</a><a onclick="return confirm('Ingin Keluar?')" href="<?= base_url('') ?>" id="back"> Back</a></p>
          </div>
        </div>
    </div>
  ...
  <div class="d-flex h-100" id="card">
    <div id="card-content">
      <div id="card-title">
        ...
        <form action="<?php echo site_url('auth_petugas/login')?>" method="post" class="form">
        ...
        <p id="signup"><a href="<?= base_url('petugas/register')?>" id="signup">Don't have account yet /</a><a onclick="return confirm('Ingin Keluar?')" href="<?= base_url('')?>" id="back"> Back</a></p>
